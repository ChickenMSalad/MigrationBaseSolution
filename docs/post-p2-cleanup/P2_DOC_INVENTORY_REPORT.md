...
- Keep final reference docs.
- Keep checkpoint docs at least until P3 starts.
- Keep set-history docs if you want historical traceability.
- Later, set-history docs can be archived into a single compressed documentation archive or summarized into a phase history document.
- Do not remove docs before the final handoff document is rewritten correctly.
