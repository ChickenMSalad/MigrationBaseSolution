...
# Generated by remove-post-p2-dropin-artifacts.ps1
...
git rm -r -- 'tools/dropins/apply-post-p2-cleanup-set001.ps1'
...
git rm -r -- 'tools/dropins/post-p2-cleanup-set001-docs-tools-inventory'
git rm -r -- 'tools/dropins/post-p2-cleanup-set001-fix'
git rm -r -- 'tools/dropins/post-p2-cleanup-set001-fix2'
git rm -r -- 'tools/dropins/post-p2-cleanup-set002-dropin-artifacts'
