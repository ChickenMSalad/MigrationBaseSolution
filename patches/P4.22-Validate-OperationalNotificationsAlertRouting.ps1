...
Assert-Contains $endpointPath "MapOperationalNotificationEndpoints"
Assert-OccursOnce $programPath "using Migration.Admin.Api.Endpoints.Operational.Notifications;"
Assert-OccursOnce $programPath "app.MapOperationalNotificationEndpoints();"
Assert-OccursOnce $appPath "import { NotificationRoutingWorkspace } from './features/notifications/NotificationRoutingWorkspace';"
Assert-OccursOnce $appPath "<NotificationRoutingWorkspace />"

Write-Host "[P4.22] Validation passed."
