...
Copy-PayloadFile "src/Core/Migration.Admin.Api/Operational/Events/OperationalEventQueryResponse.cs"
...
Copy-PayloadFile "docs/operations/P4.46-operational-event-timeline-query-surface.md"

$programPath = Join-Path $repoRoot "src/Core/Migration.Admin.Api/Program.cs"

Add-LineOnce `
    -Path $programPath `
    -Line "builder.Services.AddScoped<IOperationalEventQueryService, SqlOperationalEventQueryService>();" `
    -Anchor "builder.Services.AddScoped<IOperationalEventRetentionService, SqlOperationalEventRetentionService>();"
...
Add-LineOnce `
    ...
    -Line "        endpoints.MapOperationalEventQueryEndpoints();" `
    -Anchor "        endpoints.MapOperationalEventRetentionEndpoints();"
