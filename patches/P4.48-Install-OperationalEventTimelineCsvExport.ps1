...
Copy-PayloadFile "src/Core/Migration.Admin.Api/Endpoints/Operational/Events/OperationalEventExportEndpointExtensions.cs"
...
Copy-PayloadFile "docs/operations/P4.48-operational-event-timeline-csv-export.md"
...
Add-LineOnce `
    ...
    -Line "        endpoints.MapOperationalEventExportEndpoints();" `
    -Anchor "        endpoints.MapOperationalEventQueryEndpoints();"
