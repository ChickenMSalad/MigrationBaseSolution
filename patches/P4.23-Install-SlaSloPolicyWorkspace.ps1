...
Copy-PayloadFile "src/Core/Migration.Admin.Api/Endpoints/Operational/SlaSlo/OperationalSlaSloEndpointExtensions.cs"
Copy-PayloadFile "apps/migration-admin-ui/src/features/slaSlo/slaSloTypes.ts"
Copy-PayloadFile "apps/migration-admin-ui/src/features/slaSlo/slaSloApi.ts"
Copy-PayloadFile "apps/migration-admin-ui/src/features/slaSlo/SlaSloPolicyWorkspace.tsx"
Copy-PayloadFile "docs/operations/P4.23-sla-slo-policy-workspace.md"

$programPath = Join-Path $repoRoot "src/Core/Migration.Admin.Api/Program.cs"
Add-LineAfterLastImport $programPath "using Migration.Admin.Api.Endpoints.Operational.SlaSlo;"
Add-TextOnce `
    -Path $programPath `
    -Text "app.MapOperationalSlaSloEndpoints();" `
    -Anchor "app.MapOperationalNotificationEndpoints();" `
    -Description "SLA/SLO endpoint registration"

$appPath = Join-Path $repoRoot "apps/migration-admin-ui/src/App.tsx"
Add-LineAfterLastImport $appPath "import { SlaSloPolicyWorkspace } from './features/slaSlo/SlaSloPolicyWorkspace';"
Add-ComponentBeforeMainClose $appPath "      <SlaSloPolicyWorkspace />"
