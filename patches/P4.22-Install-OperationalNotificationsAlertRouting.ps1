...
Copy-PayloadFile "src/Core/Migration.Admin.Api/Endpoints/Operational/Notifications/OperationalNotificationEndpointExtensions.cs"
Copy-PayloadFile "apps/migration-admin-ui/src/features/notifications/notificationTypes.ts"
Copy-PayloadFile "apps/migration-admin-ui/src/features/notifications/notificationApi.ts"
Copy-PayloadFile "apps/migration-admin-ui/src/features/notifications/NotificationRoutingWorkspace.tsx"
Copy-PayloadFile "docs/operations/P4.22-operational-notifications-alert-routing.md"

$programPath = Join-Path $repoRoot "src/Core/Migration.Admin.Api/Program.cs"
Add-LineAfterLastImport $programPath "using Migration.Admin.Api.Endpoints.Operational.Notifications;"
Add-TextOnce `
    -Path $programPath `
    -Text "app.MapOperationalNotificationEndpoints();" `
    -Anchor "app.MapOperationalAuditTrailEndpoints();" `
    -Description "notification endpoint registration"

$appPath = Join-Path $repoRoot "apps/migration-admin-ui/src/App.tsx"
Add-LineAfterLastImport $appPath "import { NotificationRoutingWorkspace } from './features/notifications/NotificationRoutingWorkspace';"
Add-ComponentBeforeMainClose $appPath "      <NotificationRoutingWorkspace />"
