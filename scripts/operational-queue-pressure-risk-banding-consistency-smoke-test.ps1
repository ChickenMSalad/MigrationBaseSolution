...
$url = "$BaseUrl/api/operational/queue-pressure/risk-banding/readiness"
...
Write-Host "Consistency smoke test passed for /api/operational/queue-pressure/risk-banding"
