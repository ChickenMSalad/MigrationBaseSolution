...
$response = Invoke-RestMethod -Uri "$BaseUrl/api/operational/queue-pressure/control-tower/readiness" -Method Get
...
Write-Host "Consistency smoke test passed for operational queue pressure control tower."
