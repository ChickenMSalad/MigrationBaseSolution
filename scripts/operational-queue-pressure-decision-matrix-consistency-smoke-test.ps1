...
$url = "$BaseUrl/api/operational/queue-pressure/decision-matrix/readiness"
...
Write-Host "Consistency smoke test passed for /api/operational/queue-pressure/decision-matrix"
