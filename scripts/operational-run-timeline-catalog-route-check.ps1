...
Write-Host "Checking operational run timeline catalog route..."
...
$route = "/api/operational/runs/{runId:guid}/timeline/catalog"
...
Write-Host "Operational run timeline catalog route is mapped."
