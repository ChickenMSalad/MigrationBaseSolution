...
$readinessUrl = "$BaseUrl/api/operational/runs/$runId/completion-readiness"

Write-Host ""
Write-Host "Completion readiness:"
...
$finalizeUrl = "$BaseUrl/api/operational/runs/$runId/finalize-completion"

Write-Host ""
Write-Host "Finalizing completion:"
...
Write-Host ""
Write-Host "Projection after finalization attempt:"
