...
Assert-PathExists -RootPath $root -RelativePath 'docs\p8\P8.3D.2-Manual-Runtime-Activity-Usage-Patch.md'
...
Write-Host 'P8.3D.2 manual runtime Activity usage baseline validation passed.'
