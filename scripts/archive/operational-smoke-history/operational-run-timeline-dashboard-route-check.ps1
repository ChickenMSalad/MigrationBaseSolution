...
Write-Host "Checking operational run timeline dashboard route..."
...
$route = "/api/operational/runs/{runId:guid}/timeline/dashboard"
...
Write-Host "Operational run timeline dashboard route is mapped."
