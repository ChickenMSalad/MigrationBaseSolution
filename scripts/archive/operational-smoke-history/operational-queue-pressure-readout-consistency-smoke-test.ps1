...
$response = Invoke-RestMethod -Uri "$BaseUrl/api/operational/queue-pressure/readout/readiness" -Method Get
...
Write-Host "Consistency smoke test passed for operational queue pressure readout."
