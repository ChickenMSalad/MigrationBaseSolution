...
Write-Host "Checking global operational run timeline catalog route..."
...
$route = "/api/operational/runs/timeline/catalog"
...
Write-Host "Global operational run timeline catalog route is mapped."
