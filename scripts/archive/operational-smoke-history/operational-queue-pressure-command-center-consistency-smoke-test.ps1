...
$response = Invoke-RestMethod -Uri "$BaseUrl/api/operational/queue-pressure/command-center/readiness" -Method Get
...
Write-Host "Consistency smoke test passed for operational queue pressure command center."
