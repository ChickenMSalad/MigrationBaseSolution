...
$url = "$BaseUrl/api/operational/queue-pressure/safety-review/readiness"
...
Write-Host "Consistency smoke test passed for /api/operational/queue-pressure/safety-review"
