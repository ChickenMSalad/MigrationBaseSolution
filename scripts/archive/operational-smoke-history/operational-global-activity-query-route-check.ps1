...
Write-Host "Checking global operational activity query route..."
...
$route = "/api/operational/activity/query"
...
Write-Host "Global operational activity query route is mapped."
