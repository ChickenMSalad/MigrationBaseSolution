...
$url = "$BaseUrl/api/operational/queue-pressure/operator-advisory/readiness"
...
Write-Host "Consistency smoke test passed for /api/operational/queue-pressure/operator-advisory"
