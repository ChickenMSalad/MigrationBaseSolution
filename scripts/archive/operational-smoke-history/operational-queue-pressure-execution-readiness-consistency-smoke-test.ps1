...
$url = "$BaseUrl/api/operational/queue-pressure/execution-readiness/readiness"
...
Write-Host "Consistency smoke test passed for /api/operational/queue-pressure/execution-readiness"
