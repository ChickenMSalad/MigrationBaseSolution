...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatcherReadinessStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatcherReadinessIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatcherReadinessReport.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatcherReadinessRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\IAzureWorkerDispatcherReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatcherReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatcherReadinessOptions.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchHandoffDescriptor.cs',
    'config\azure-runtime\worker\worker-dispatch-readiness.sample.json'
)
...
Write-Host 'P6.4.6 queue dispatcher readiness closeout validation passed.'
