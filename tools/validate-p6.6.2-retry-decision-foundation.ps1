...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureRetryDecision.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureRetryPolicy.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureRetryDecisionRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\IAzureRetryDecisionEngine.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureRetryDecisionEngine.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureRetryRuntimeOptions.cs',
    'config\azure-runtime\failure-runtime\retry-runtime.sample.json'
)
...
Write-Host 'P6.6.2 retry decision foundation validation passed.'
