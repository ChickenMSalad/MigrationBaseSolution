...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationScenario.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\IAzureEndToEndValidationRunner.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationRunner.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationOptions.cs',
    'config\azure-runtime\end-to-end-validation\end-to-end-validation.sample.json'
)
...
Write-Host 'P6.8.1 end-to-end validation scenario foundation validation passed.'
