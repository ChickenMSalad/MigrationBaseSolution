...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureIncidentStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureIncidentRecord.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureIncidentRecordRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureIncidentRecordResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\IAzureFailureIncidentStore.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\InMemoryAzureFailureIncidentStore.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureIncidentOptions.cs',
    'config\azure-runtime\failure-runtime\failure-incident.sample.json'
)
...
Write-Host 'P6.6.4 failure incident history foundation validation passed.'
