...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchCoordinatorOptions.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchClaimBatchRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchClaimedWorkItem.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchClaimBatchResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\IAzureWorkerDispatchCoordinator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchCoordinator.cs',
    'config\azure-runtime\worker\worker-dispatch-coordinator.sample.json'
)
...
Write-Host 'P6.4.3 queue dispatcher claim coordinator validation passed.'
