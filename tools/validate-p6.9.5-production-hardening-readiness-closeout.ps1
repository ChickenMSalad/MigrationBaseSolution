...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionHardeningReadinessStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionHardeningReadinessIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionHardeningReadinessRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionHardeningReadinessReport.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\IAzureProductionHardeningReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionHardeningReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionHardeningHandoffDescriptor.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionHardeningCloseoutOptions.cs',
    'config\azure-runtime\production-hardening\production-hardening-closeout.sample.json'
)
...
Write-Host 'P6.9.5 production hardening readiness closeout validation passed.'
