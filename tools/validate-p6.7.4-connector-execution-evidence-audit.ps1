...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionEvidenceRecord.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionEvidenceRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionEvidenceResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\IAzureConnectorExecutionEvidenceSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\InMemoryAzureConnectorExecutionEvidenceSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionAuditHandoff.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionEvidenceOptions.cs',
    'config\azure-runtime\connector-execution\connector-execution-evidence.sample.json'
)
...
Write-Host 'P6.7.4 connector execution evidence audit validation passed.'
