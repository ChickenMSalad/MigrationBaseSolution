...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReleaseGateStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReleaseGateIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReleaseGateRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReleaseGateResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\IAzureProductionReleaseGateEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReleaseGateEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReleaseGateOptions.cs',
    'config\azure-runtime\production-hardening\production-release-gate.sample.json'
)
...
Write-Host 'P6.9.1 production release gate foundation validation passed.'
