...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionItemRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\IAzureManifestExecutionItemHandler.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\NoOpAzureManifestExecutionItemHandler.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionBatchRunRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionBatchRunResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\IAzureManifestExecutionBatchRunner.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionBatchRunner.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionRunnerOptions.cs',
    'config\azure-runtime\manifest-execution\manifest-execution-runner.sample.json'
)
...
Write-Host 'P6.5.4 manifest execution runner foundation validation passed.'
