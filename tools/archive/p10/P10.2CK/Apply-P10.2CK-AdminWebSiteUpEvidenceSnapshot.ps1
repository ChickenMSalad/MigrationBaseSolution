...
$reportPath = Join-Path $docsDir 'P10.2CK-AdminWebSiteUpEvidenceSnapshot.Report.md'
...
[void]$lines.Add('')
[void]$lines.Add('Adds a report-only local evidence snapshot runner for Admin Web site-up readiness.')
[void]$lines.Add('')
[void]$lines.Add('## Files')
[void]$lines.Add('')
[void]$lines.Add('- `tools/p10/P10.2CK/Run-P10.2CK-AdminWebSiteUpEvidenceSnapshot.ps1`')
[void]$lines.Add('- `artifacts/p10/P10.2CK/site-up-evidence.md` generated by the runner')
[void]$lines.Add('')
[void]$lines.Add('## Notes')
[void]$lines.Add('')
[void]$lines.Add('This set does not alter Admin Web source files.')

Set-Content -Path $reportPath -Value $lines -Encoding UTF8
Write-Host ('Wrote report: {0}' -f $reportPath)
Write-Host 'P10.2CK Admin Web site-up evidence snapshot applied.'
