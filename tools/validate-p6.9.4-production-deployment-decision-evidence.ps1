...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionDeploymentDecisionStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionDeploymentDecisionRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionDeploymentDecision.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\IAzureProductionDeploymentDecisionEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionDeploymentDecisionEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionDeploymentEvidenceRecord.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionDeploymentOptions.cs',
    'config\azure-runtime\production-hardening\production-deployment.sample.json'
)
...
Write-Host 'P6.9.4 production deployment decision evidence validation passed.'
