...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReadinessItemStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReadinessChecklistItem.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReadinessChecklist.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReadinessChecklistRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\IAzureProductionReadinessChecklistBuilder.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReadinessChecklistBuilder.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionSignoffRecord.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionReadinessOptions.cs',
    'config\azure-runtime\production-hardening\production-readiness.sample.json'
)
...
Write-Host 'P6.9.3 production readiness checklist validation passed.'
