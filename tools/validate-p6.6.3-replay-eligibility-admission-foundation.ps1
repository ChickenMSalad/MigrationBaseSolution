...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureReplayEligibilityDecision.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureReplayEligibilityRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\IAzureReplayEligibilityEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureReplayEligibilityEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureReplayAdmissionRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureReplayAdmissionDecision.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\IAzureReplayAdmissionController.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureReplayAdmissionController.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureReplayRuntimeOptions.cs',
    'config\azure-runtime\failure-runtime\replay-runtime.sample.json'
)
...
Write-Host 'P6.6.3 replay eligibility admission foundation validation passed.'
