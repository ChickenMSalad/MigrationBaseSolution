...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndEvidenceReportStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndEvidenceEntry.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndEvidenceReport.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndEvidenceReportRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\IAzureEndToEndEvidenceReportBuilder.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndEvidenceReportBuilder.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndEvidenceReportOptions.cs',
    'config\azure-runtime\end-to-end-validation\end-to-end-evidence-report.sample.json'
)
...
Write-Host 'P6.8.3 end-to-end evidence report validation passed.'
