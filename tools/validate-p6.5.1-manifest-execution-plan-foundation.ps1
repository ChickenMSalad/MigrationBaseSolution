...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionMode.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionScope.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionPlanStep.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionPlan.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionPlanRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\IAzureManifestExecutionPlanBuilder.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionPlanBuilder.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionOptions.cs',
    'config\azure-runtime\manifest-execution\manifest-execution.sample.json'
)
...
Write-Host 'P6.5.1 manifest execution plan foundation validation passed.'
