...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureClassification.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureSeverity.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureSignal.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureClassificationResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\IAzureFailureClassifier.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureClassifier.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeOptions.cs',
    'config\azure-runtime\failure-runtime\failure-runtime.sample.json'
)
...
Write-Host 'P6.6.1 failure classification foundation validation passed.'
