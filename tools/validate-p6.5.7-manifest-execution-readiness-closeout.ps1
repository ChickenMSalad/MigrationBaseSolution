...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionReadinessStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionReadinessIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionReadinessRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionReadinessReport.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\IAzureManifestExecutionReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionHandoffDescriptor.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCloseoutOptions.cs',
    'config\azure-runtime\manifest-execution\manifest-execution-closeout.sample.json'
)
...
Write-Host 'P6.5.7 manifest execution readiness closeout validation passed.'
