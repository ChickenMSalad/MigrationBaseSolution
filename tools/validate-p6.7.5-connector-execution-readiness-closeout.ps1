...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionReadinessStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionReadinessIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionReadinessRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionReadinessReport.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\IAzureConnectorExecutionReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionHandoffDescriptor.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionCloseoutOptions.cs',
    'config\azure-runtime\connector-execution\connector-execution-closeout.sample.json'
)
...
Write-Host 'P6.7.5 connector execution readiness closeout validation passed.'
