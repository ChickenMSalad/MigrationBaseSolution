...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndDryRunStepStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndDryRunStepResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndDryRunRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndDryRunResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\IAzureEndToEndDryRunHarness.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndDryRunHarness.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndDryRunHarnessOptions.cs',
    'config\azure-runtime\end-to-end-validation\end-to-end-dry-run-harness.sample.json'
)
...
Write-Host 'P6.8.2 end-to-end dry-run harness validation passed.'
