...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchCompletionStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchCompletionRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchCompletionResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\IAzureWorkerDispatchCompletionSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\InMemoryAzureWorkerDispatchCompletionSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchCompletionOptions.cs',
    'config\azure-runtime\worker\worker-dispatch-completion.sample.json'
)
...
Write-Host 'P6.4.4 queue dispatcher completion foundation validation passed.'
