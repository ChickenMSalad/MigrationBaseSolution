...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationReadinessStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationReadinessIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationReadinessRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationReadinessReport.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\IAzureEndToEndValidationReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationHandoffDescriptor.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\EndToEndValidation\AzureEndToEndValidationCloseoutOptions.cs',
    'config\azure-runtime\end-to-end-validation\end-to-end-validation-closeout.sample.json'
)
...
Write-Host 'P6.8.4 end-to-end validation readiness closeout validation passed.'
