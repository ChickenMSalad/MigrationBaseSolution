...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionItem.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionBatch.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionBatchRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionBatchResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\IAzureManifestExecutionBatchProvider.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\InMemoryAzureManifestExecutionBatchProvider.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionItemResultStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionItemResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionBatchOptions.cs',
    'config\azure-runtime\manifest-execution\manifest-execution-batch.sample.json'
)
...
Write-Host 'P6.5.3 manifest execution batch foundation validation passed.'
