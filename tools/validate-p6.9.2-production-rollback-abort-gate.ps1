...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionRollbackTrigger.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionRollbackDecisionStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionRollbackRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionRollbackDecision.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\IAzureProductionRollbackEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionRollbackEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionAbortRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionAbortDecision.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\IAzureProductionAbortController.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionAbortController.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ProductionHardening\AzureProductionRollbackOptions.cs',
    'config\azure-runtime\production-hardening\production-rollback.sample.json'
)
...
Write-Host 'P6.9.2 production rollback abort gate validation passed.'
