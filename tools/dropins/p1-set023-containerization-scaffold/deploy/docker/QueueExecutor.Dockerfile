# Migration Queue Executor container scaffold
...
COPY ["src/Workers/Migration.Workers.QueueExecutor/Migration.Workers.QueueExecutor.csproj", "src/Workers/Migration.Workers.QueueExecutor/"]
...
RUN dotnet restore "src/Workers/Migration.Workers.QueueExecutor/Migration.Workers.QueueExecutor.csproj"

COPY . .
RUN dotnet publish "src/Workers/Migration.Workers.QueueExecutor/Migration.Workers.QueueExecutor.csproj" -c Release -o /app/publish --no-restore
...
ENTRYPOINT ["dotnet", "Migration.Workers.QueueExecutor.dll"]
