...
$validators = @(
    @{ Name = "Operational diagnostics stack"; Script = ".\tools\test\validate-operational-diagnostics-stack.ps1"; Args = @("-BaseUrl", $BaseUrl) },
    @{ Name = "Auth + operations stack"; Script = ".\tools\test\validate-auth-operations-stack.ps1"; Args = @("-BaseUrl", $BaseUrl) }
)
