...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCheckpointRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCheckpointResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\IAzureManifestExecutionCheckpointStore.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\InMemoryAzureManifestExecutionCheckpointStore.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCheckpointPolicy.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCheckpointOptions.cs',
    'config\azure-runtime\manifest-execution\manifest-execution-checkpoint.sample.json'
)
...
Write-Host 'P6.5.5 manifest execution checkpoint foundation validation passed.'
