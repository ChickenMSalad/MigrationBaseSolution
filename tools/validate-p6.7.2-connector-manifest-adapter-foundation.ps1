...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureManifestConnectorExecutionMapper.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionResultMapper.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorManifestItemHandlerOptions.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorManifestItemHandler.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionFailureSignalMapper.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorManifestAdapterReadiness.cs',
    'config\azure-runtime\connector-execution\connector-manifest-adapter.sample.json'
)
...
Write-Host 'P6.7.2 connector manifest adapter foundation validation passed.'
