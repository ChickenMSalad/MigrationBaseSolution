...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCompletionStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCompletionRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCompletionRecord.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCompletionResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\IAzureManifestExecutionCompletionSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\InMemoryAzureManifestExecutionCompletionSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionAuditHandoff.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ManifestExecution\AzureManifestExecutionCompletionOptions.cs',
    'config\azure-runtime\manifest-execution\manifest-execution-completion.sample.json'
)
...
Write-Host 'P6.5.6 manifest execution completion handoff validation passed.'
