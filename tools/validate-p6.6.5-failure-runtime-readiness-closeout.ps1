...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeReadinessStatus.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeReadinessIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeReadinessRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeReadinessReport.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\IAzureFailureRuntimeReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeReadinessEvaluator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeHandoffDescriptor.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\FailureRuntime\AzureFailureRuntimeCloseoutOptions.cs',
    'config\azure-runtime\failure-runtime\failure-runtime-closeout.sample.json'
)
...
Write-Host 'P6.6.5 failure runtime readiness closeout validation passed.'
