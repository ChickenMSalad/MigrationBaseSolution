...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionValidationSeverity.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionValidationIssue.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionValidationResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionValidationOptions.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\IAzureConnectorExecutionValidator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionValidator.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionPreflightRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionPreflightResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\IAzureConnectorExecutionPreflight.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\ConnectorExecution\AzureConnectorExecutionPreflight.cs',
    'config\azure-runtime\connector-execution\connector-execution-validation.sample.json'
)
...
Write-Host 'P6.7.3 connector execution validation preflight validation passed.'
