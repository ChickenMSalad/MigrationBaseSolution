...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchDeadLetterReason.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchDeadLetterRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchDeadLetterResult.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\IAzureWorkerDispatchDeadLetterSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\InMemoryAzureWorkerDispatchDeadLetterSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchDeferRequest.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\IAzureWorkerDispatchDeferralSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\InMemoryAzureWorkerDispatchDeferralSink.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Worker\Dispatch\AzureWorkerDispatchDeadLetterOptions.cs',
    'config\azure-runtime\worker\worker-dispatch-deadletter.sample.json'
)
...
Write-Host 'P6.4.5 queue dispatcher dead-letter deferral foundation validation passed.'
