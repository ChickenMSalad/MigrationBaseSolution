...
$expectedFiles = @(
    'src\Core\MigrationBase.Core\Cloud\Azure\Observability\Anomalies\AzureAnomalyDetectionRuleDescriptor.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Observability\Anomalies\AzureAnomalyDetectionRuleSeverity.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Observability\Anomalies\AzureAnomalyDetectionWindow.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Observability\Anomalies\AzureAnomalyDetectionThreshold.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Observability\Anomalies\AzureAnomalyDetectionRuleCatalog.cs',
    'src\Core\MigrationBase.Core\Cloud\Azure\Observability\Anomalies\IAzureAnomalyDetectionRuleCatalog.cs',
    'config\azure-runtime\observability\anomalies\anomaly-rules.sample.json'
)
...
Write-Host 'P5.4.7 Azure observability anomaly detection contract validation passed.'
