    ...
    public static RouteGroupBuilder MapProjectEndpoints(this RouteGroupBuilder api)
    {
        ...
        api.MapGet("/projects", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                return Results.Ok(projects.OrderByDescending(x => x.UpdatedUtc));
            })
        ...
        api.MapPost("/projects", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                {
                    return Results.BadRequest(new AdminApiErrorResponse(
                        "DisplayName, SourceType, TargetType, and ManifestType are required."));
                }
            ...
            .Produces<MigrationProjectRecord>(StatusCodes.Status201Created)
        ...
        api.MapPut("/projects/{projectId}", async (
            ...
            .Produces<MigrationProjectRecord>(StatusCodes.Status200OK)
        ...
        api.MapDelete("/projects/{projectId}", async (
                ...
                IAdminProjectStore store,
                CancellationToken cancellationToken) =>
                await store.DeleteProjectAsync(projectId, cancellationToken).ConfigureAwait(false)
                    ? Results.NoContent()
                    : Results.NotFound())
