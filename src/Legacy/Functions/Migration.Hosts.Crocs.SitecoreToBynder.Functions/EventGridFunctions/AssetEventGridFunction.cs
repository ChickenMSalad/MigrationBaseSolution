...
using Migration.Hosts.Crocs.SitecoreToBynder.Functions.Models;
using Newtonsoft.Json;

namespace Migration.Hosts.Crocs.SitecoreToBynder.Functions.EventGridFunctions;

public sealed class AssetEventGridFunction(ILogger<AssetEventGridFunction> logger)
{
    private const string QueueName = "sitecore-bynder-jobs";
    ...
    public async Task Run([EventGridTrigger] CloudEvent cloudEvent)
    {
        ...
        logger.LogInformation("Queued Sitecore/Bynder blob url {Url}", blobData.Url);
    }
}
